...
;;the following code is a hard-coded measurement example of the distortion made by Quinn
;; The distortion measurement must give values to a,b vectors
;; Use the distortion calibration file if you just want to correct for distortion
...
;;;
return, error(' No distortion measurement code implemented yet.')
;*(dataset.currframe[0])=
suffix+='-distor'
