...
CASE !VERSION.OS_FAMILY OF  
	...
	'unix': begin
		...
		GPI_PIPELINE_DIR=gpi_expand_path("$GPI_IFS_DIR/pipeline/")
...
GPI_CONFIG_FILE=	GPI_PIPELINE_DIR+path_sep()+'dpl_library'+path_sep()+'DRSConfig.xml'
...
;   file_test(GPI_PIPELINE_DIR,/directory, /write) && $
...
;      setenv,'GPI_PIPELINE_DIR='+GPI_PIPELINE_DIR
;      setenv,'GPI_PIPELINE_LOG_DIR='+GPI_PIPELINE_LOG_DIR
;      setenv,'GPI_PIPELINE_DRF_DIR='+GPI_PIPELINE_LOG_DIR
