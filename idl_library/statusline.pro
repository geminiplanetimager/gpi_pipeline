...
;     case, CM, 12 Oct 2001
;
;  $Id: statusline.pro,v 1.1.1.1 2009/10/09 19:33:08 gpi Exp $
;
;-
; Copyright (C) 1998, 1999, 2000, 2001, Craig Markwardt
...
pro statusline, str, col, length=length, clear=clear, $
  ...
  if n_elements(statusline_enabled) EQ 0 then begin
      ...
      if strmid(termtype,0,2) EQ 'vt' OR termtype EQ 'xterm' OR $
