...
FUNCTION wrapper, xdim,ydim,refwlcal,lensletarray,badpixels,wlcalsize,startx,starty,whichpsf
...
k=w
    ...
    ;if bestnorm NE bestnorm then continue
    ;if float(j) EQ float(wstart) then max=bestnorm
...
print, 'Ending parameters for lenslet wavecal', bestres

;print, "Ending parameters for gaussian: ", bestres[4], bestres[5], bestres[6]
print, "_______________________________________________________________"

if array_equal(start_params[0:1], bestres[0:1]) then message,/info, "WARNING - SAME START AND END POSITIONS"
