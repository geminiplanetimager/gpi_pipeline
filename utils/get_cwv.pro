...
;-
  ...
  case parseband of
     ...
     3: CommonWavVect=[1.495, 1.802, 37]     ;was[1.495, 1.7938, 37] according to 50% filter transmission instead of CommonWavVect=[1.5, 1.8, 37]
     4:                        
     5:  CommonWavVect=[1.8992, 2.1862, 37]   ;was [1.9, 2.19, 40]
     6: CommonWavVect=[2.1182, 2.3848, 37]    ;was [2.13, 2.4, 40]
  endcase
