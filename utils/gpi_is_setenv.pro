...
if keyword_set(first) then begin 
	...
	vars_to_test = ['GPI_IFS_DIR','GPI_PIPELINE_DIR', 'GPI_PIPELINE_LOG_DIR', 'GPI_DRF_TEMPLATES_DIR', 'GPI_QUEUE_DIR', 'GPI_CONFIG_FILE', 'GPI_RAW_DATA_DIR', 'GPI_DRP_OUTPUT_DIR']
