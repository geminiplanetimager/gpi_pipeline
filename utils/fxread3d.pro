	PRO FXREAD3D, FILENAME, DATA, HEADER, P1, P2, P3, P4, P5,     $
...
;
	ALREADY_CONVERTED = 0
        ...
        if ~keyword_set(nslice) then nslice=0
;
...
;
	...
	N1 = DIMS[0]
	IF NAXIS ge 2 THEN N2 = DIMS[1] ELSE N2=1
;
