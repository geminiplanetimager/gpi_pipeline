...
setenv, 'GPI_DRPQUEUE_DIR='+getenv('GPI_DRP_DIR')+path_sep()+'queue'+path_sep()   ; DRF Queue directory
setenv, 'GPI_DRP_CONFIG_DIR='+getenv('GPI_DRP_DIR')+path_sep()+'config'+path_sep()+'gpi_pipeline_primitives.xml'
