...
#
setenv IDL_PATH "+/home/labuser1/GPI/pipeline:${IDL_PATH}"  #  ** CHANGE REQUIRED** location of the pipeline and external directories
setenv PATH "${PATH}:/home/labuser1/GPI/pipeline/scripts" 	#  ** CHANGE REQUIRED** the scripts directory located in the pipeline directory which is located in the directory declared just above
