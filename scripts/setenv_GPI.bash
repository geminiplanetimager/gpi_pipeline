...
export GPI_PIPELINE_DIR="$GPI_IFS_DIR/pipeline/"	# pipeline software
export GPI_PIPELINE_LOG_DIR="$GPI_IFS_DIR/logs/"		# default log dir
export GPI_DRF_TEMPLATES_DIR="$GPI_PIPELINE_DIR/drf_templates/"	# template Data Reduction Files
export GPI_QUEUE_DIR="$GPI_PIPELINE_DIR/queue/"		# DRF Queue directory
export GPI_CONFIG_FILE="$GPI_PIPELINE_DIR/dpl_library/drsConfig.xml"
...
export PATH="${PATH}:${GPI_PIPELINE_DIR}/scripts"
