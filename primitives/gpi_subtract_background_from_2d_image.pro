;+
; NAME: gpi_subtract_background_from_2d_image
; PIPELINE PRIMITIVE DESCRIPTION: Subtract background from 2D image
;
...
;   2013-07-17 MP: Rename for consistency. TBD deprecate and remove this?
;-
function gpi_subtract_background_from_2d_image, DataSet, Modules, Backbone
