;+
; NAME: wavelength_solution_2d_par.pro
; PIPELINE PRIMITIVE DESCRIPTION: Parallel 2D Wavelength Solution
;
...
function gpi_wavelength_solution_2d_par, DataSet, Modules, Backbone
