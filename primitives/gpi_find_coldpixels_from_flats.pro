;+
; NAME: gpi_find_coldpixels_from_flats
; PIPELINE PRIMITIVE DESCRIPTION: Find Cold Pixels from a set of Flats
;
...
function gpi_find_coldpixels_from_flats, DataSet, Modules, Backbone
primitive_version= '$Id: gpi_find_hotpixels_from_darks.pro 1256 2013-02-08 22:55:59Z mperrin $' ; get version from subversion to store in header history
@__start_primitive
