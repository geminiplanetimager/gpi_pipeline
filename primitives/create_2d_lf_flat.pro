;+
; NAME: create Low Frequency Flat 2D
; PIPELINE PRIMITIVE DESCRIPTION: create Low Frequency Flat 2D
; 
...
;-
function create_2d_LF_flat, DataSet, Modules, Backbone
primitive_version= '$Id: destripe_mask_spectra_micro.pro 1558 2013-05-31 18:42:08Z jruffio $' ; get version from subversion to store in header history
@__start_primitive
