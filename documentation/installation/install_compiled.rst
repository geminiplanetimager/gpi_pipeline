 ...
 * `gpi_pipeline_1.4.0_compiled.zip <http://www.stsci.edu/~mperrin/gpi/downloads/gpi_pipeline_1.4.0_compiled.zip>`_ -  GPI pipeline compiled code only
 * `gpi_pipeline_1.4.0_runtime_macosx.zip <http://www.stsci.edu/~mperrin/gpi/downloads/gpi_pipeline_1.4.0_runtime_macosx.zip>`_ - GPI pipeline compiled code plus IDL runtime for Mac OS X
 * `gpi_pipeline_1.4.0_runtime_linux.zip <http://www.stsci.edu/~mperrin/gpi/downloads/gpi_pipeline_1.4.0_runtime_linux.zip>`_ - GPI pipeline compiled code plus IDL runtime for Linux
 * `gpi_pipeline_1.4.0_runtime_windows.zip <http://www.stsci.edu/~mperrin/gpi/downloads/gpi_pipeline_1.4.0_runtime_windows.zip>`_ - GPI pipeline compiled code plus IDL runtime for Windows
 * `gpi_pipeline_1.4.0_source.zip <http://www.stsci.edu/~mperrin/gpi/downloads/gpi_pipeline_1.4.0_source.zip>`_ -  GPI pipeline source code (available for reference)
